...
$I->wantTo('check if REST API test environment works');
$I->amHttpAuthenticated('api', 'RlI1FOWCkuGLKEdNBi9j');
$I->sendGET("http://esign.site8.co/api/v1");
$I->seeResponseCodeIs(200);
$I->seeResponseContains('[{"id":1,');

$I->wantTo("POST a record in the API");
$I->amHttpAuthenticated('api', 'RlI1FOWCkuGLKEdNBi9j');
$I->sendPOST("http://esign.site8.co/api/v1", [
    "hotkey" => "",
...
$newlyCreatedRecordId = $responseArr['id'];
$I->wantTo("Check if record is inserted in the database");
$I->sendGET("http://esign.site8.co/api/v1/" . $newlyCreatedRecordId);
$I->seeResponseCodeIs(200);
codecept_debug($I->grabResponse());
//codecept_debug($retrievedArr);
//codecept_debug($newlyCreatedRecordId);
//codecept_debug($retrievedArr['id'] == $newlyCreatedRecordId);