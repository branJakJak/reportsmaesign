...
class m170110_113101_add_addressinformation extends Migration
{
    public function safeUp()
    {
        ...
        $this->addColumn('{{%ppi_lead}}', 'address5', $this->text());
        $this->addColumn('{{%ppi_lead}}', 'postcode', $this->text());        
        $this->addColumn('{{%ppi_lead}}', 'prev_address1', $this->text());
        $this->addColumn('{{%ppi_lead}}', 'prev_address2', $this->text());
        $this->addColumn('{{%ppi_lead}}', 'prev_address3', $this->text());
        $this->addColumn('{{%ppi_lead}}', 'prev_address4', $this->text());
        $this->addColumn('{{%ppi_lead}}', 'prev_address5', $this->text());
        $this->addColumn('{{%ppi_lead}}', 'prev_postcode', $this->text());
    ...
    public function safeDown()
    {
        ...
        $this->dropColumn('{{%ppi_lead}}','address5');
        $this->dropColumn('{{%ppi_lead}}','postcode');

        $this->dropColumn('{{%ppi_lead}}','prev_address1');
        $this->dropColumn('{{%ppi_lead}}','prev_address2');
        $this->dropColumn('{{%ppi_lead}}','prev_address3');
        $this->dropColumn('{{%ppi_lead}}','prev_address4');
        $this->dropColumn('{{%ppi_lead}}','prev_address5');
        $this->dropColumn('{{%ppi_lead}}','prev_postcode');
