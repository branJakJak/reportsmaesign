...
class m161205_143309_add_new_cols_lead_esign extends Migration
{
    ...
    {
        $this->addColumn('{{%lead_esign}}', 'complaint_reference', $this->string());
        $this->addColumn('{{%lead_esign}}', 'financial_business_name', $this->string());
        $this->addColumn('{{%lead_esign}}', 'last_3_digit_account_num', $this->string());
        $this->addColumn('{{%lead_esign}}', 'is_complain_about_sale_packaged_bank_account', $this->string());
        ...
        $this->addColumn('{{%lead_esign}}', 'notice_account_fees_on_statements', $this->string());
        $this->addColumn('{{%lead_esign}}', 'notice_account_fees_on_statements_details', $this->text());
        $this->addColumn('{{%lead_esign}}', 'current_situation_packaged_bank_account', $this->string());
        $this->addColumn('{{%lead_esign}}', 'current_situation_packaged_bank_account_explanation', $this->text());
        $this->addColumn('{{%lead_esign}}', 'is_address_outside_UK_at_package_upgrade', $this->string());
        ...
        $this->addColumn('{{%lead_esign}}', 'declaration_confirmed_tick', $this->string());
        $this->addColumn('{{%lead_esign}}', 'occupation', $this->string());
        /*complain with*/
        $this->addColumn('{{%lead_esign}}', 'salutation_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'firstname_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'lastname_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'occupation_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'date_of_birth_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'postcode_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'address1_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'address2_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'address3_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'address4_complain_with', $this->string());
        $this->addColumn('{{%lead_esign}}', 'mobile_complain_with', $this->string());

        $this->addColumn('{{%lead_esign}}', 'behalf_of_charity_official_name', $this->string());
        $this->addColumn('{{%lead_esign}}', 'behalf_of_charity_num_of_employees', $this->string());
        $this->addColumn('{{%lead_esign}}', 'behalf_of_charity_num_of_partners', $this->string());
        $this->addColumn('{{%lead_esign}}', 'behalf_of_charity_annual_income', $this->string());

        $this->addColumn('{{%lead_esign}}', 'business_responsible_details_name', $this->string());
        $this->addColumn('{{%lead_esign}}', 'business_responsible_details_address', $this->text());
        $this->addColumn('{{%lead_esign}}', 'business_responsible_details_phone', $this->string());

        $this->addColumn('{{%lead_esign}}', 'adviser_detail_name', $this->string());
        $this->addColumn('{{%lead_esign}}', 'adviser_detail_address', $this->text());
        $this->addColumn('{{%lead_esign}}', 'adviser_detail_phone', $this->string());

        $this->addColumn('{{%lead_esign}}', 'kind_of_service_complain', $this->string());
        $this->addColumn('{{%lead_esign}}', 'kind_of_service_complain_reference', $this->string());
        ...
        // $this->addColumn('{{%lead_esign}}', 'when_opened_account_has_other_account', $this->string());
