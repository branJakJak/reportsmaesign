...
class m161012_101753_create_table_lead extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%lead_esign}}', [
            ...
            'tried_to_claim_for_insurance_products_rejection_reason' => $this->string(),
            ...
            'understanding_of_features_and_benefits'=> $this->string(),//show this if registered_benefits_by_packaged_account is yes
            'address_while_bank_opened'=> $this->string(),//[non uk address, uk address]
            'bank_account_status'=> $this->string(),//[account in Arrears , Account in Debt Management , Account in IVA , Bankrupt]
            'bank_account_status_comment'=> $this->string(),//[account in Arrears , Account in Debt Management , Account in IVA , Bankrupt]
            'has_account_upgraded_downgraded'=> $this->string(),//[yes,no]
            'upgrade_comment'=> $this->string(),//
            ...
            'reason_to_takeout_packaged_account_reason_of_speaking' => $this->string(),// add check box to include cant remember
