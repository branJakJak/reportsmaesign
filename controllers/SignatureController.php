    ...
    public function actionPpi($securityKey)
    {
        ...
        if ($requestedLead) {
            ...
            if ($requestedLead->load(\Yii::$app->request->post())) {
                ...
                if (isset($requestedLead->reason_of_borrowing) && !empty($requestedLead->reason_of_borrowing)) {
                    $requestedLead->reason_of_borrowing = implode(",", $requestedLead->reason_of_borrowing);
                }
                if (isset($requestedLead->bought_cover_with_ppi_insurance) && !empty($requestedLead->bought_cover_with_ppi_insurance)) {
